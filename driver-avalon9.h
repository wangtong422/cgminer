...
#define AVA9_DEFAULT_ASIC_AVERAGE_TEMP_START	13
#define AVA9_DEFAULT_ASIC_AVERAGE_TEMP_END	22
#define AVA9_DEFAULT_ASIC_AVERAGE_TEMP_COUNT	60
...
struct avalon9_info {
	...
	int temp_average[AVA9_DEFAULT_MODULARS][AVA9_DEFAULT_MINER_CNT][AVA9_DEFAULT_ASIC_MAX];
